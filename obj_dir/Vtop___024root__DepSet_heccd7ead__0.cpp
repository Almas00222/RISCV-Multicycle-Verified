...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    SData/*14:0*/ __VdlyDim0__top__DOT__mem__DOT__RAM__v0;
    ...
    if (vlSelfRef.MemWrite) {
        ...
        __VdlyDim0__top__DOT__mem__DOT__RAM__v0 = (0x7fffU 
                                                   & (vlSelfRef.Adr 
                                                      >> 2U));
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.top__DOT__ctrl__DOT__saved_pc = 0U;
        ...
        if ((1U == (IData)(vlSelfRef.top__DOT__ctrl__DOT__current_state))) {
            vlSelfRef.top__DOT__ctrl__DOT__saved_pc 
                = vlSelfRef.instr;
        }
        vlSelfRef.WriteData = vlSelfRef.rd2;
        if (vlSelfRef.top__DOT__trap_entry_sig) {
            vlSelfRef.top__DOT__csr_file__DOT__mcause 
                = vlSelfRef.mcause;
        }
        vlSelfRef.mcause = vlSelfRef.top__DOT__ctrl__DOT__mcause_next;
        ...
        if (vlSelfRef.PCWrite) {
            vlSelfRef.pcout = ((2U & (IData)(vlSelfRef.top__DOT__PCSrc))
        ...
        if (vlSelfRef.top__DOT__trap_entry_sig) {
            vlSelfRef.top__DOT__csr_file__DOT__mepc 
                = vlSelfRef.top__DOT__trap_pc_sig;
        }
    }
